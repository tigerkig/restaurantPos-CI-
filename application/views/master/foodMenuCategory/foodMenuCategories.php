    ...
    <section class="content-header">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="btn_list m-right bg-blue-btn btn" href="<?php echo base_url() ?>foodMenuCategory/addEditFoodMenuCategory">
                   <i data-feather="plus"></i> <?php echo lang('add_food_menu_category'); ?></a>
...
<script src="<?php echo base_url(); ?>frequent_changing/js/custom_report.js"></>